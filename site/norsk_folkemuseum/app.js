...
const mainQA = [
  ...
  {q:"Hvordan er erfaringen din med analyse?", type:"text", text:"Jeg har god erfaring med å følge opp trafikk og resultater fra digitale flater. Både i Egmont og i Canal Digital/Allente har jeg jobbet med analyse, A/B-testing og kontinuerlig optimalisering av innhold.<br><br>Jeg liker å bruke data til å forstå hva som fungerer, og synes det er motiverende å se hvordan små justeringer kan gi bedre resultater.", media:[]},
