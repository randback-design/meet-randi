...
const mainQA = [
  ...
  {q:"Hvorfor søker du denne stillingen?", type:"text", text:"Et selskap i sterk vekst, med reelt ansvar og stor frihet til å teste nye idéer, er akkurat den typen rolle jeg ser etter nå. Jeg liker godt at dere kombinerer kreativitet med analyse og datadrevne beslutninger, og at markedsarbeidet skal måles på konkrete resultater, ikke bare synlighet.<br><br>Jeg har lang erfaring med akkurat den kombinasjonen av innhold, kampanjer og digital markedsføring dere beskriver, og trives godt med høyt tempo og variasjon i arbeidsdagen.", media:[]},
  {q:"Hva mener du er det viktigste du kan bidra med hos oss?", type:"text", text:"Jeg har bred erfaring akkurat fra den typen arbeid dere beskriver. I Allente jobbet jeg med CRM og var med på å utvikle en ny mal for MessageGears, samtidig som jeg jobbet tett med A/B-testing på nettsiden og landingssider sammen med e-comm-teamet. Jeg har også laget annonser mot ulike målgrupper, både i Allente og VG.<br><br>Jeg kan det grunnleggende innen SEO 🔍, og følger med på hvordan feltet utvikler seg med AI-søk. Tverrfaglig samarbeid er jeg godt vant til, internt og med eksterne partnere – noe jeg fikk god trening i helt fra starten i Canal Digital (som senere ble Allente), der jeg jobbet med optimalisering av nettsider.<br><br>Jeg har også noe erfaring med B2B-markedsføring, blant annet gjennom et POS-materiell-prosjekt jeg jobbet med over et års tid.", media:[]},
  {q:"Har du erfaring med Google Ads og Meta Business Suite?", type:"text", text:"Jeg har ikke jobbet direkte i Google Ads eller Meta Business Suite ennå, men jeg har god erfaring med Bannerflow til annonseproduksjon, og med å lage annonser mot ulike målgrupper. Jeg setter meg raskt inn i nye annonseplattformer, og har ingen problemer med å lære meg verktøyene dere bruker.", media:[]},
  {q:"Hvilken erfaring har du med WordPress?", type:"text", text:"Jeg har litt erfaring med WordPress, men har brukt Episerver mest gjennom de siste stillingene mine.", media:[]},
