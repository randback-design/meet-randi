...
// ── FAQ ──
const mainQA = [
  {q:"Så... hvem er du da?", type:"video", text:"Jeg er Randi, grafisk designer, innholdsprodusent og «markedsperson» med 20 års erfaring fra mediebransjen, og en bred kompetanse innen visuell og tekstlig kommunikasjon. Jeg liker å lage innhold som faktisk blir lagt merke til (og brukt), og jeg er også veldig glad i å skrive.<br><br>Dessuten er jeg kreativ, sosial, leken og ganske glad i tempo og mange baller i luften, uten at det går på bekostning av mitt behov for god orden, struktur og overblikk. 🎨 ✅<br><br>Og så er jeg mamma, samboer, hundeeier og en ivrig konsert- og teatergjenger. 🎵🐶 Mer om meg i denne animasjonsfilmen jeg har laget:", media:[{type:"video",vimeoId:"1187345684",vimeoHash:"f8b46e121d"}]},
  {q:"Hvorfor søker du denne stillingen?", type:"text", text:"Et selskap i sterk vekst, med reelt ansvar og stor frihet til å teste nye idéer, er akkurat den typen rolle jeg ser etter nå. Jeg liker spesielt godt at dette er en bred rolle, der jeg kan jobbe med både merkevare, innhold, kampanjer og digitale flater, og samtidig være tett på både salg og resten av organisasjonen.<br><br>Jeg har lang erfaring med mye av det dere beskriver, og trives godt med høyt tempo, variasjon og med å drive ting fremover fra idé til ferdig leveranse. Muligheten til å være med og bygge videre på både merkevaren og markedsarbeidet deres høres rett og slett veldig spennende ut.", media:[]},
  {q:"Hva mener du er det viktigste du kan bidra med hos oss?", type:"text", text:"Jeg tror først og fremst jeg kan bidra med bredde og gjennomføringskraft. Jeg er vant til å jobbe med mange deler av markedsarbeidet samtidig, og liker å ta ansvar hele veien fra idé og planlegging til ferdig innhold og kampanje.<br><br>I Allente jobbet jeg blant annet med CRM og var med på å utvikle en ny mal for MessageGears, samtidig som jeg jobbet tett med A/B-testing på nettsiden og landingssider sammen med e-comm-teamet. Jeg har også laget annonser mot ulike målgrupper, både i Allente og VG, og jobbet med merkevarebygging og innhold på tvers av mange kanaler.<br><br>Jeg har også noe erfaring med B2B-markedsføring, blant annet gjennom et POS-materiell-prosjekt jeg jobbet med over et års tid. Jeg er vant til tverrfaglig samarbeid, både internt og med eksterne partnere, og trives godt når jeg får kombinere kreativitet, struktur og det å faktisk få ting gjort.", media:[]},
  {q:"Har du erfaring med Google Ads og Meta Business Suite?", type:"text", text:"Jeg har ikke jobbet direkte i Google Ads eller Meta Business Suite ennå, men jeg har lang erfaring med digital annonseproduksjon og med å lage annonser og innhold mot ulike målgrupper. I Allente jobbet jeg blant annet mye i Bannerflow, som jeg også var med på å implementere i markedsavdelingen.<br><br>Jeg er vant til å lære nye digitale verktøy, og ser ikke dette som noen stor terskel. Tvert imot er det et område jeg gjerne vil bli bedre på.", media:[]},
  {q:"Hvilken erfaring har du med WordPress?", type:"text", text:"Jeg har noe erfaring med WordPress, men har jobbet mest i Episerver de siste årene. Jeg har lang erfaring med publisering og innholdsarbeid på web, og er komfortabel med å jobbe i CMS og sette meg inn i nye løsninger.", media:[]},
  {q:"Har du erfaring fra produktlanseringer?", type:"text", text:"Ja, jeg har jobbet med innhold i forbindelse med produktlanseringer, blant annet planlegging av nyhetsbrev, SoMe-innhold og landingssider knyttet til lansering av nye produkter. Dere finner et eksempel på en lanseringstekst under «Tekstprøver» lenger ned på siden. 👇", media:[]},
  {q:"Hvilke programmer jobber du i?", type:"text", text:"Jeg jobber i de fleste av de store programmene i Adobe CC: Photoshop, InDesign, Illustrator, Premiere og After Effects. Mer om dette ser dere i en egen blokk lengre ned på denne siden. 👇<br><br>Jeg har god erfaring med Episerver som CMS, og har blant annet bidratt til å implementere både Monday.com (prosjektstyring) og Bannerflow (annonseproduksjon) på min siste arbeidsplass.", media:[]},
  {q:"Alle snakker om AI. Hva er dine tanker om det?", type:"text", text:"Jeg var skeptisk til AI i starten. De første AI-bildene av folk med seks fingre gjorde meg ikke akkurat overbevist. 😅 I dag bruker jeg AI hver eneste dag til idéutvikling, research, korrektur og raske prototyper.<br><br>Denne nettsiden er laget ved hjelp av mange timer med vibe-coding i Claude.", media:[]},
