...
const mainQA = [
  ...
  {q:"Hvorfor søker du på denne jobben?", type:"text", text:"Anita Systems bygger noe jeg synes er genuint spennende: et moderne, skybasert journalsystem for tannklinikker, i sterk vekst og med ambisjoner om internasjonal ekspansjon. Jeg liker den kombinasjonen av teknologi og reelt nyttebehov – dere gjør noe komplisert enklere for folk som jobber i en hektisk klinikkhverdag, og det er nettopp den typen historier jeg liker å fortelle.<br><br>Jeg har jobbet mye med å omsette tekniske nyheter og produktoppdateringer til innhold folk faktisk forstår og bruker – noe som ligner godt på det dere beskriver i stillingen. Jeg trives også godt med å ha eierskap til en hel prosess, fra idé til ferdig resultat, og liker å jobbe tett med utvikling, support og salg for å finne de riktige historiene.<br><br>Muligheten til å bygge og forme en digital tilstedeværelse fra grunnen av, i et selskap som vokser raskt, er noe jeg blir motivert av.", media:[]},
  {q:"Hva mener du er det viktigste du kan bidra med hos oss?", type:"text", text:"Jeg tror det viktigste jeg kan bidra med er å eie hele den digitale kommunikasjonen deres – fra strategi og idé til ferdig, publisert innhold. Jeg har bred erfaring med innholdsproduksjon, som gjør at jeg kan se helheten og produsere mye selv: skrive, illustrere, redigere bilder og video, lage landingssider og nyhetsbrev.<br><br>Jeg er også vant til å samarbeide tett med utviklere og tekniske miljøer for å oversette produktoppdateringer og nye funksjoner til innhold som er lett å forstå for kundene – noe som er en sentral del av rollen hos dere.<br><br>I tillegg liker jeg å følge med på hva som fungerer, og justere innhold basert på data og innsikt, slik at kommunikasjonen faktisk gir resultater – ikke bare ser bra ut.<br><br>Jeg har også noe erfaring med B2B-markedsføring, blant annet gjennom et POS-materiell-prosjekt jeg jobbet med over et års tid. Jeg følger gjerne med på tall i Google Analytics og har grunnleggende kunnskap om å skrive for SEO – men synes det er minst like interessant å skrive for AI i dag, siden det fort blir en enda viktigere kanal for hvordan innhold blir funnet og forstått.<br><br>Jeg behersker norsk og engelsk godt, både skriftlig og muntlig, og er komfortabel med å snakke engelsk i jobbsammenheng. På skriftlig engelsk bruker jeg gjerne litt ekstra korrektur før noe går ut, for å sikre at det sitter helt riktig.", media:[]},
  {q:"Få høre litt om innhold du har produsert da!", type:"text", text:"Jeg har produsert innhold for mange ulike målgrupper gjennom de siste 20 årene, men målet har alltid vært det samme: å få folk til å stoppe opp, lese, klikke eller komme tilbake.<br><br>I Egmont var jeg nettredaktør for Julia og jobbet også med donald.no. Jeg skrev artikler, laget quizzer og konkurranser, modererte forum og utviklet innhold for barn og unge.<br><br>I VG jobbet jeg i et in-house-byrå, der vi utviklet kreative annonsekonsepter med animasjoner, spill og interaktive løsninger.<br><br>I Allente produserte jeg blant annet landingssider, nyhetsbrev, innhold til sosiale medier og video, og jobbet mye med A/B-testing for å finne de løsningene som fungerte best.<br><br>Jeg har også erfaring med å formidle kundehistorier og suksesshistorier – å finne den gode vinkelen i et case og gjøre det relevant for andre i samme situasjon.", media:[]},
  ...
  {q:"Hvilke programmer jobber du i?", type:"text", text:"Jeg jobber i de fleste av de store programmene i Adobe CC: Photoshop, InDesign, Illustrator, Premiere og After Effects. Mer om dette ser dere i en egen blokk lengre ned på denne siden.<br><br>Jeg har noe elementær erfaring med Figma, og selv om jeg ikke har brukt Canva før, har jeg god erfaring med Illustrator – som gjør at jeg raskt vil kjenne meg igjen i hvordan Canva fungerer. Jeg er også glad i å lære nye programmer og verktøy, og har bidratt til å implementere både Monday.com (prosjektstyring) og Bannerflow (annonseproduksjon) på min siste arbeidsplass.", media:[]},
  {q:"Er det noe du synes er spesielt gøy å jobbe med?", type:"text", text:"Jeg blir ekstra motivert når jeg får ta noe komplisert og gjøre det enkelt og engasjerende – enten det er en ny funksjon i et produkt, eller en teknisk prosess ingen utenfor fagmiljøet forstår.<br><br>Videoklipping og illustrasjon er dessuten noe av det jeg liker aller best å jobbe med. Der synes jeg video og animasjon er et utrolig godt verktøy, fordi det kan forklare noe på få sekunder som ellers ville tatt mange avsnitt tekst.", media:[]},
