...
const mainQA = [
  ...
  {q:"Hvorfor søker du på denne jobben?", type:"text", text:"Jeg skal innrømme at teppebransjen er nytt terreng for meg, men stillingsannonsen deres traff meg overraskende godt! Jeg elsker jobber der jeg får være med på hele løpet, fra idé og strategi til publisering og resultater, og det er akkurat det dere beskriver. Bredden i oppgavene, digital markedsføring, SoMe, produkttekster, messer og foto/video, er rett og slett drømmekombinasjonen for meg. Jeg blir motivert av å få bidra litt overalt, og stort handlingsrom er noe jeg trives ekstra godt med.<br><br>Og så må jeg jo si det: å få «sette mitt preg på gulvet» høres rett og slett gøy ut. 😄 Reiseveien fra Nittedal er dessuten helt perfekt, så dette var en søknad jeg fikk skikkelig lyst til å skrive.", media:[]},
  {q:"Hva kan du bidra med hos Inhouse Group?", type:"text", text:"Jeg kan brukes til veldig mye, og jeg trives godt med en variert hverdag. Dere ønsker en som kan jobbe med digital markedsføring, SoMe og salgsmateriell, både digitalt og på papir. Det er akkurat det jeg gjør! Jeg liker å filme med mobilen, klipper video, kommer opp med nye idéer, illustrerer, publiserer på web, skriver tekster, lager annonser og trykksaker, og jobber tett med partnere og kunder.<br><br>Jeg har også jobbet som nettredaktør og er vant til å publisere på nett og sette meg raskt inn i nye systemer. Jeg har erfaring med Google Analytics og kjenner til grunnleggende SEO og SEM, og følger også godt med på AEO, altså hvordan innhold blir plukket opp av AI-søk.", media:[]},
  {q:"Har du erfaring med messer?", type:"text", text:"Ja, faktisk! I Allente var jeg med på å planlegge og designe messestands, så jeg kjenner godt til hva som skal til for å få en stand til å se innbydende ut og fange oppmerksomheten.<br><br>Og så liker jeg godt den mellommenneskelige biten også. Jeg prater gjerne med folk, og har i tillegg pedagogisk utdanning (PPU), noe som gjør at jeg trives godt med å forklare og formidle, enten det er til en kollega eller en besøkende på en stand.", media:[]},
  ...
  {q:"Jobber du strukturert?", type:"text", text:"Ja! Kreative folk er vel ofte kjent for litt kaos og mange baller i luften. Det siste liker jeg, men jeg er faktisk et skikkelig ordensmenneske, og elsker lister og gode systemer.", media:[]},
  ...
  {q:"Hvordan kontakter vi deg?", type:"text", text:"Ring meg på 97 72 03 15, eller send en mail til backmarkrandi@gmail.com 📩<br><br>Jeg blir bare glad om jeg blir «kalt inn på teppet» til en prat. Da hopper jeg i bilen, og kommer med en gang.", media:[]}
];
