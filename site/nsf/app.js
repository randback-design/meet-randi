...
const mainQA = [
  ...
  {q:"Hvorfor søker du denne stillingen?", type:"text", text:"Denne stillingen traff meg skikkelig fordi den kombinerer mye av det jeg liker aller best å jobbe med: nett, tekst, struktur, brukeropplevelse og visuell kommunikasjon.<br><br>Jeg har mye erfaring med å skrive og publisere på nett, følge opp trafikk og bruke innsikt til å gjøre forbedringer. Jeg er også vant til å samarbeide med utviklere, og til å få artikler og landingssider til å se bra ut samtidig som de gjør jobben de er ment for.<br><br>Jeg har ingen erfaring fra sykepleiefaget, men er flink til å sette meg inn i nye ting, bearbeide dem og formidle informasjon på en tydelig og lettfattelig måte. Gjerne med støtte fra video, illustrasjon eller animasjon når det gjør budskapet enklere å forstå.", media:[]},
  {q:"Fortell om erfaringen din som nettredaktør", type:"text", text:"Som nettredaktør for julia.no, Juliabladets tidligere nettside, hadde jeg ansvar for innhold, videreutvikling og trafikk. Sammen med redaktøren jobbet jeg målrettet med å øke trafikken og skape engasjement blant brukerne.<br><br>Jeg har også vært en del av flere redaksjoner opp gjennom årene, blant annet Donald-redaksjonen i Egmont. Jeg kjenner derfor godt til redaksjonelt arbeid, publisering og det å følge opp innhold over tid.<br><br>I Allente jobbet jeg mye med landingssider og optimalisering på nettsidene våre, på tvers av de nordiske markedene. Jeg er vant til å samarbeide tett med både utviklere, UX-designere, tekstforfattere og andre fagmiljøer om innhold og forbedringer.", media:[]},
  {q:"Hva er ditt forhold til klarspråk?", type:"text", text:"Klarspråk ligger veldig naturlig for meg. Jeg unngår vanskelige ord og liker å skrive rett fram og forståelig, nesten som om jeg skulle snakket direkte til deg.<br><br>Jeg er opptatt av å korte ned når det trengs, dele opp teksten, lage tydelige overskrifter og bruke punktlister. Bilder, illustrasjoner og video kan også gjøre komplisert informasjon enklere å forstå.<br><br>For meg handler klarspråk først og fremst om å tenke på leseren hele veien. Ikke skrive for å imponere, men for å bli forstått.", media:[]},
  {q:"Har du erfaring med universell utforming?", type:"text", text:"Jeg har jobbet en del med universell utforming som grafisk designer i Allente, blant annet i en periode der jeg samarbeidet tett med UX-designere om forbedringer på nettsiden.<br><br>Der lærte jeg mye om hvordan man tenker tilgjengelighet inn i struktur, kontraster og lesbarhet – ikke som noe man legger på i etterkant, men som en del av selve designprosessen. Det er en tankegang jeg har tatt med meg videre.", media:[]},
  {q:"Har du erfaring med å lede en redaksjon?", type:"text", text:"Jeg har ikke hatt en formell lederrolle, men har jobbet i flere redaksjoner, blant annet Julia og Donald i Egmont. Jeg er vant til redaksjonelt samarbeid og til å holde oversikt over oppgaver, innhold og leveranser.<br><br>Jeg er strukturert av natur og liker å lage gode systemer som gjør samarbeidet enklere. I Allente var jeg blant annet med på å implementere Monday.com og ble etter hvert superbruker – den folk kom til når de trengte hjelp. Jeg liker å dele kunnskap, skape struktur og få ting til å henge sammen for hele teamet.", media:[]},
  {q:"Hvordan er erfaringen din med innsikt og brukertesting?", type:"text", text:"Jeg har ikke jobbet med formell brukertesting, men har god erfaring med å bruke trafikkdata og innsikt. Som nettredaktør for julia.no hadde jeg ansvar for trafikken og fulgte utviklingen tett i Google Analytics. Innsikten brukte vi til å forstå hva som fungerte og til å gjøre bedre valg for innholdet på siden.<br><br>Jeg er fortsatt opptatt av dette. Jeg har blant annet satt opp min egen oversikt i Vercel for å følge besøkstall på nettsidene jeg lager – også denne søknadssiden. Jeg liker å forstå hva som fungerer, og justere deretter.", media:[]},
  {q:"Hvilke programmer jobber du i?", type:"text", text:"Jeg jobber i de fleste av de store programmene i Adobe CC: Photoshop, InDesign, Illustrator, Premiere og After Effects. Mer om dette ser dere i en egen blokk lenger ned på siden. 👇<br><br>Jeg har god erfaring med Episerver som CMS og lærer raskt nye programmer og verktøy. Jeg har blant annet vært med på å implementere både Monday.com for prosjektstyring og Bannerflow for annonseproduksjon på min siste arbeidsplass.", media:[]},
  {q:"Hva med SEO, AI og KI-synlighet?", type:"text", text:"Jeg var skeptisk til AI i starten. De første AI-bildene av folk med seks fingre gjorde meg ikke akkurat overbevist. 😅 I dag bruker jeg AI hver dag til blant annet idéutvikling, research, korrektur og raske prototyper.<br><br>Jeg har jobbet med innhold for nett i mange år og kjenner prinsippene for SEO og hvordan struktur, overskrifter og relevant innhold påvirker synlighet. Samtidig følger jeg med på hvordan søk er i endring, og hvordan innhold også kan gjøres lettere å finne og forstå for AI-drevne søketjenester.<br><br>Dette er et område i rask utvikling som jeg synes er skikkelig spennende, særlig for en nettside som skal gjøre viktig informasjon tilgjengelig for mange.", media:[]},
  {q:"Hva med det sosiale?", type:"text", text:"Jeg bidrar med humor, godt humør, tørre ordspill, musikktips og engasjement. I min forrige jobb satt jeg mange år i sosialkomitéen og bidro til et godt miljø på jobb – og til at det ble både sommerfest og julebord. 🎉", media:[]},
  {q:"Når kan du eventuelt starte i ny jobb?", type:"text", text:"Jeg er fleksibel og kan starte på veldig kort varsel!<br><br>Etter en større nedbemanning i Allente er jeg nå på jakt etter nye utfordringer. I mellomtiden fyller jeg dagene med å lære nye ting, blant annet innen AI og animasjon.<br><br>Har dere lyst til å se en arbeidsprøve på noe spesielt, lager jeg gjerne det. 😊", media:[]},
