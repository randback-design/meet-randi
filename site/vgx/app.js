...
// ── FAQ ──
const mainQA = [
  {q:"Så... hvem er du da?", type:"video", text:"Jeg heter Randi, og har jobbet med design i snart 20 år. Mest som grafisk og digital designer, men egentlig litt alt mulig innen visuell kommunikasjon og markedsføring.<br><br>Dessuten er jeg kreativ, sosial, leken og ganske glad i tempo og mange baller i luften – uten at det går på bekostning av mitt behov for god orden, struktur og overblikk. 🎨 ✅<br><br>Og så er jeg mamma til tre fine ungdommer, samboer, hundeeier og en ivrig konsert- og teatergjenger. 🎵 Mer om meg i denne animasjonsfilmen jeg har laget:", media:[{type:"video",vimeoId:"1187345684",vimeoHash:"f8b46e121d"}]},
  {q:"Hvorfor søker du denne jobben?", type:"text", text:"Jeg søker denne stillingen fordi det høres veldig spennende ut å få være med å utvikle måten unge tar til seg nyheter på. Min kreativitet og interesse for AI og andre nye verktøy, gjør at jeg synes det høres ekstra gøy ut å jobbe med dette. Det å få muligheten til å teste nye ideer og tanker, for så å lære av dem og gjøre endringer, er akkurat slik jeg liker å jobbe.<br><br>Dessuten kjenner jeg miljøet i VG som godt, framoverlent og inspirerende, etter å ha jobbet 4 år i det som i dag heter Schibsted Create.", media:[]},
  ...
  {q:"Hvordan tilpasser du kommunikasjon til ulike målgrupper?", type:"text", text:"I Egmont var jeg nettredaktør for jentebladet Julia, og jobbet også med donald.no – begge rettet mot en ung målgruppe. Der lærte jeg at unge lesere vil ha noe helt annet enn voksne: kort, direkte og engasjerende, uten omveier. Senere i Allente jobbet jeg også mye med voksne samarbeidspartnere og landingssider, der tillit og en tydelig, profesjonell tone betyr mer.<br><br>Den erfaringen har lært meg at ulike målgrupper krever ganske ulik tilnærming. Til unge voksne handler det om å fenge raskt der de er, som på TikTok og Instagram – kort, visuelt og uten omveier. Til voksne samarbeidspartnere og beslutningstakere handler det mer om tillit og en tydelig, profesjonell tone. Jeg trives godt med å veksle mellom disse registrene.", media:[]},
  ...
  {q:"Og AI, hvordan bruker du det?", type:"text", text:"Jeg var skeptisk til AI i starten, men i dag er ChatGPT og Claude nesten som kollegaer – vi sparrer, bygger og løser ting sammen gjennom hele arbeidsdagen. 😄<br><br>Det siste halvåret har jeg vibe-codet meg gjennom en hel liten stabel prosjekter: motivasjonsapper til ungdommene mine, en poengtellingsapp til hageleker, et prosjektstyringsverktøy for jobbsøknadene mine, og en god del søknadssider som denne. Jeg bruker Claude sammen med GitHub, Vercel og Firebase for å få ting fra idé til noe som faktisk fungerer.<br><br>Blant favorittene er en liten app til datteren min, der måltider blir til poeng som får en hage til å vokse: <a href='https://mat-motivator.vercel.app/' target='_blank' style='color:var(--t1);font-weight:700'>mat-motivator.vercel.app →</a><br><br>Jeg liker fortsatt best å skrive selv når det gjelder ord og tekst, men å oppdage at jeg kan gå fra idé til ferdig produkt uten å kunne kode fra før, har åpnet en helt ny måte å jobbe kreativt på. Og det er akkurat den nysgjerrigheten jeg har lyst til å ta med inn i VG X.", media:[]},
  {q:"Har du en idé til et nytt nyhetsformat?", type:"text", text:"Jeg lastet ned appen for å se hvordan dere jobber i dag, og kan ikke se at dere har personalisering av hvordan man vil se en sak, eller hva man er interessert i og ikke – det er utgangspunktet for idéen min.<br><br>Min idé handler om enda mer brukertilpasset innhold. Klarer man å effektivisere produksjonen nok (ved hjelp av for eksempel AI) til å presentere en sak på flere måter, kan leseren selv velge hvordan de vil ta imot nyhetene i appen. Noen vil gå i dybden, andre vil bare ha det viktigste. Noen foretrekker video og grafikk, andre vil heller høre nyhetene opplest i bilen eller på bussen.<br><br>I tillegg kunne jeg tenke meg en «Trender nå»-funksjon, som viser hvilke saker andre – gjerne filtrert på egen aldersgruppe – leser og snakker om akkurat nå. Det handler litt om å sikre seg at man er «med i gjengen», og ikke går glipp av noe alle andre allerede har fått med seg.<br><br>Om jeg skal bruke eksempelet deres med 23-åringen og de 15–20 artiklene: ved hjelp av AI kan vi hente ut det viktigste fra hver sak. Siden journalister som regel oppsummerer i starten av en sak, er sjansen stor for at mye av innholdet gjentar seg – og AI kan sammenfatte alt i en punktliste, der man kan klikke seg videre på det som virker spesielt interessant.<br><br>Konkret ser jeg for meg dette som en egen widget i appen: en «I dag»-flate som viser dagens viktigste saker, tilpasset det leseren faktisk følger. Hver sak oppsummeres kort med bilde og én setning, med mulighet til å klikke seg videre. Widgeten har også pushvarsler, som melder fra så snart det kommer noe nytt innenfor det leseren følger.<br><br>Både headinger og språk i widgeten er bevisst holdt korte og direkte – tilpasset en yngre målgruppe som vil ha budskapet raskt, uten omveier.<div style='max-width:280px;margin:24px auto 0;position:relative'><div style='position:absolute;top:-13px;left:50%;transform:translateX(-50%);width:calc(100% - 20px);background:rgba(28,28,30,.97);backdrop-filter:blur(6px);border-radius:14px;padding:9px 11px;display:flex;gap:9px;align-items:flex-start;box-shadow:0 10px 24px rgba(0,0,0,.3);z-index:2'><div style='width:24px;height:24px;border-radius:7px;background:var(--t1);flex-shrink:0;display:flex;align-items:center;justify-content:center;font-size:12px'>🔔</div><div><div style='color:#fff;font-size:10.5px;font-weight:800'>VG X · nå</div><div style='color:#d5d5d7;font-size:10.5px;margin-top:1px'>Psst 👀 nytt om Klima – trykk her</div></div></div><div style='background:#0c0c0c;border-radius:38px;padding:11px;padding-top:32px;box-shadow:0 24px 60px rgba(0,0,0,.28)'><div style='background:#0c0c0c;border-radius:28px;overflow:hidden;position:relative;padding-top:13px'><div style='width:64px;height:17px;background:#000;border-radius:10px;margin:0 auto 11px'></div><div style='background:linear-gradient(180deg,#1c1c1e,#0c0c0c);padding:0 11px 16px'><div style='display:flex;align-items:center;gap:6px;padding:9px 4px 11px'><div style='width:7px;height:7px;border-radius:50%;background:var(--t1)'></div><div style='color:#fff;font-size:10.5px;font-weight:800;letter-spacing:.05em;text-transform:uppercase'>Din dag ⚡</div></div><div style='background:#17181a;border-radius:15px;padding:9px;display:flex;flex-direction:column;gap:9px'><div style='display:flex;gap:9px;align-items:center'><div style='width:40px;height:40px;border-radius:10px;flex-shrink:0;background:linear-gradient(135deg,#409f89,#2d7a68);display:flex;align-items:center;justify-content:center;font-size:17px'>📈</div><div><div style='color:#fff;font-size:12px;font-weight:800;line-height:1.3'>Har du råd til å flytte for deg selv?</div><div style='color:#8b8b8f;font-size:10px;margin-top:2px'>Økonomi · 20 sek</div></div></div><div style='height:1px;background:#2a2a2c'></div><div style='display:flex;gap:9px;align-items:center'><div style='width:40px;height:40px;border-radius:10px;flex-shrink:0;background:linear-gradient(135deg,#e8b64a,#c9922a);display:flex;align-items:center;justify-content:center;font-size:17px'>🌍</div><div><div style='color:#fff;font-size:12px;font-weight:800;line-height:1.3'>Klimarapporten: dette bør du vite</div><div style='color:#8b8b8f;font-size:10px;margin-top:2px'>Klima · 25 sek</div></div></div><div style='height:1px;background:#2a2a2c'></div><div style='display:flex;gap:9px;align-items:center'><div style='width:40px;height:40px;border-radius:10px;flex-shrink:0;background:linear-gradient(135deg,#7b6ff0,#5a4fd6);display:flex;align-items:center;justify-content:center;font-size:17px'>⚽</div><div><div style='color:#fff;font-size:12px;font-weight:800;line-height:1.3'>Landslaget klare til kamp i kveld</div><div style='color:#8b8b8f;font-size:10px;margin-top:2px'>Sport · 15 sek</div></div></div></div><div style='display:flex;align-items:center;gap:6px;padding:11px 4px 0'><span style='font-size:11px'>🎯</span><div style='color:#8b8b8f;font-size:9.5px'>Basert på det du følger: Økonomi, Klima, Sport</div></div></div></div></div><div style='text-align:center;color:var(--muted);font-size:11px;margin-top:9px'>Skisse av en «I dag»-widget i VG X – fiktivt eksempelinnhold</div></div><br><br>Jo mer VG X kan tilpasse hvordan en sak vises til ulike lesere, jo bedre – for eksempel ved å skru av sport eller kjendisstoff for dem som ikke er interessert.<br><br>For å tenke videre på å nå ulike målgrupper: kanskje noen av influencerne eller andre kjente personer kunne «låne stemmen sin» til å lese opp nyhetssaker? Ikke at de skal lese den inn selv, men det går jo an å få tekster opplest i valgfri stemme. Man kunne også tilby saker opplest på flere språk, for å favne enda bredere.", media:[]},
