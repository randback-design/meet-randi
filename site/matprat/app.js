...
// ── FAQ ──
const mainQA = [
  {q:"Så... hvem er du da?", type:"video", text:"Jeg er Randi – innholdsprodusent, grafisk designer og «markedsperson» med 20 års erfaring fra mediebransjen, og en bred kompetanse innen kommunikasjon og innholdsproduksjon. Jeg liker å lage innhold som faktisk blir lagt merke til (og brukt), og jeg er også veldig glad i å skrive.<br><br>Dessuten er jeg kreativ, sosial, leken og ganske glad i tempo og mange baller i luften – uten at det går på bekostning av mitt behov for god orden, struktur og overblikk. 🎨 ✅<br><br>Og så er jeg mamma, samboer, hundeeier og en ivrig konsert- og teatergjenger. 🎵 Mer om meg i denne animasjonsfilmen jeg har laget:", media:[{type:"video",vimeoId:"1187345684",vimeoHash:"f8b46e121d"}]},
  {q:"Hvorfor søker du på denne jobben?", type:"text", text:"Matprat er en avsender jeg har hatt et forhold til lenge, rett og slett fordi mat er noe som angår alle, hver eneste dag. Å få jobbe med å gjøre kunnskap om ernæring, bærekraft og norsk matproduksjon forståelig og relevant for folk flest, er akkurat den typen formidling jeg liker best.<br><br>Jeg tror dette er en jobb der jeg får god bruk for både kreativiteten og nysgjerrigheten min. Rollen virker å gi mye rom for å teste ut nye ting, prøve nye formater og vinklinger, og lære mer underveis, noe jeg trives ekstra godt med.<br><br>Jeg liker også tanken på å samarbeide tett med fagfolk på ernæring og bærekraft, for å sikre at innholdet både engasjerer og stemmer faglig. Jeg har ikke fagbakgrunn innen ernæring eller bærekraft selv, men jeg har oppriktig lyst til å lære mer om dette, dersom jeg er aktuell for denne stillingen.", media:[]},
  {q:"Hva mener du er det viktigste du kan bidra med hos oss?", type:"text", text:"Jeg tror det viktigste jeg kan bidra med er å gjøre kunnskap og budskap forståelig, relevant og engasjerende for ulike målgrupper. Jeg er glad i å skrive, og har erfaring med innhold på tvers av kanaler – kampanjer, nettside, sosiale medier og andre digitale flater – samtidig som jeg har et godt øye for visuelt innhold som støtter opp under budskapet. Å finne riktig tone og de riktige ordene for en sak er noe jeg bruker mye tid på, og jeg liker godt å redigere og finpusse helt til teksten sitter.<br><br>Jeg har bred erfaring med innholdsproduksjon, som gjør at jeg kan se helheten og produsere mye selv: skrive, illustrere, redigere bilder og video, og drive en produksjon fra idé til ferdig publisert innhold.<br><br>Jeg er strukturert og vant til å levere på flere prosjekter samtidig, og jeg liker godt å samarbeide tett med fagpersoner for å sikre at innholdet er både engasjerende og korrekt – noe jeg vet er sentralt i denne rollen.", media:[]},
  {q:"Hva er ditt forhold til mat, ernæring og bærekraft?", type:"text", text:"Som forelder har jeg kjent på hvor vanskelig det kan være å vite hva som faktisk er gode valg, og hvor mange ulike råd og påstander man møter om mat og ernæring i en travel hverdag.<br><br>Det er også noe av grunnen til at jeg synes god kunnskapsformidling på dette området er så interessant. Jeg har blitt mer opptatt av ernæring de siste årene, og synes det er spennende å lære mer om hvordan mat, helse, produksjon og bærekraft henger sammen.<br><br>Jeg har nylig begynt å bruke appen Foodvisor, som jeg synes er både gøyal og lærerik. Jeg har stor tro på gamification for læring generelt, og synes den er et godt eksempel på hvordan kunnskap om ernæring kan gjøres engasjerende og lettfattelig gjennom et godt digitalt grensesnitt.<br><br>Jeg er ikke fagperson på ernæring eller bærekraft, men jeg er nysgjerrig, leser meg gjerne opp, og er vant til å sette meg raskt inn i nye temaer og gjøre dem forståelige for andre.", media:[]},
  {q:"Hvordan jobber du med SEO og kanaltilpasning?", type:"text", text:"Jeg kan det grunnleggende innen SEO, og har jobbet en del med å tilpasse budskap til ulike kanaler og formater, fra nettside og nyhetsbrev til sosiale medier og annonser. Jeg følger også med på hvordan søk er i endring, og hvordan innhold også bør gjøres lettere å finne og forstå for AI-drevne søketjenester.<br><br>For meg handler kanaltilpasning først og fremst om å tenke på hvordan folk faktisk møter innholdet, og justere lengde, tone og format deretter, uten at kjernen i budskapet endrer seg.", media:[]},
  {q:"Hvordan håndterer du problemstillinger der ulike hensyn må balanseres?", type:"text", text:"Jeg får ofte høre at jeg er diplomatisk i måten jeg håndterer ting på, og det tror jeg er nyttig når flere fagmiljøer eller perspektiver skal møtes i samme sak. Jeg liker å lytte meg til hvor de ulike hensynene faktisk ligger, stille spørsmål underveis, og finne fram til en vinkling eller et budskap alle kan stå bak, uten at det blir vagt eller utvannet.<br><br>Fra Allente er jeg vant til å jobbe tett med flere fagmiljøer og avdelinger samtidig, der ikke alle nødvendigvis er enige om vinkling eller prioritering i utgangspunktet. Jeg trives med den typen prosesser, og med å bidra til at vi lander på noe som fungerer for alle parter.", media:[]},
  ...
  {q:"Er det noe du synes er spesielt gøy å jobbe med?", type:"text", text:"Jeg trives med en variert hverdag, men innrømmer gjerne at jeg blir litt ekstra glad når jeg får illustrere eller animere. Å ta noe som er komplisert eller abstrakt, og gjøre det visuelt og lett å forstå, synes jeg er noe av det mest givende med jobben.", media:[]},
