...
const mainQA = [
  ...
  {q:"Hva mener du er det viktigste du kan bidra med hos oss?", type:"text", text:"Jeg tror det viktigste jeg kan bidra med er å skrive og formidle gode, engasjerende tekster på tvers av kanaler – kampanjer, nettside, sosiale medier og andre digitale flater – samtidig som jeg har et godt øye for visuelt innhold som støtter opp under budskapet. Å finne riktig tone og de riktige ordene for en sak er noe jeg bruker mye tid på, og jeg liker godt å redigere og finpusse helt til teksten sitter.<br><br>Jeg har bred erfaring med innholdsproduksjon, som gjør at jeg kan se helheten og produsere mye selv: skrive, illustrere, redigere bilder og video, og drive en produksjon fra idé til ferdig publisert innhold.<br><br>Jeg er strukturert og vant til å levere på flere prosjekter samtidig, og jeg liker godt å samarbeide tett med fagpersoner for å sikre at innholdet er både engasjerende og korrekt – noe jeg vet er sentralt i denne rollen.", media:[]},
  {q:"Hva er ditt forhold til mat, ernæring og bærekraft?", type:"text", text:"Som forelder har jeg kjent på hvor vanskelig det kan være å vite hva som faktisk er bra mat, og hvordan man tar gode valg i en travel hverdag.<br><br>Jeg prøver selv å velge så rene og lite prosesserte råvarer som mulig, og har blitt mer og mer bevisst på hva vi faktisk spiser hjemme. Vi dyrker litt selv og har høner i hagen, så jeg kjenner meg godt igjen i tankegangen bak mye av det Matprat formidler.<br><br>Jeg er for tiden ganske opptatt av ernæring, og har nylig begynt å bruke appen Foodvisor, som jeg synes er både gøyal og lærerik. Jeg har for øvrig stor tro på gamification for læring generelt, og Foodvisor er et godt eksempel på hvordan man kan gjøre kunnskap om ernæring engasjerende og lettfattelig gjennom et godt digitalt grensesnitt, noe jeg tenker er svært overførbart til denne rollen.<br><br>Jeg er ikke fagperson på ernæring eller bærekraft, men jeg er nysgjerrig, leser meg gjerne opp, og er vant til å sette meg raskt inn i nye temaer og gjøre dem forståelige for andre.", media:[]},
