...
const referanser = [
  ...
  {type:"quote",
   text:"Du er en af de mest pålidelige og behagelige personer, jeg har arbejdet sammen med. Uanset hvor mange projekter og opgaver der kom ind, kunne man altid regne med, at du leverede høj kvalitet, havde styr på detaljerne og samtidig bevarede overblikket. Det, jeg især husker, er din positive indstilling, din hjælpsomhed og den måde, du får samarbejdet til at glide let – du er simpelthen en kollega, der gør både projekter og arbejdsdage bedre for dem omkring dig.",
   textMobile:"Du er en af de mest pålidelige og behagelige personer, jeg har arbejdet sammen med. Uanset hvor mange projekter og opgaver der kom ind, kunne man altid regne med, at du leverede høj kvalitet, havde styr på detaljerne og samtidig bevarede overblikket. Det, jeg især husker, er din positive indstilling, din hjælpsomhed og den måde, du får samarbejdet til at glide let.",
   name:"Jens Thorsen",role:"Customer Acquisition Manager – Tidligere kollega i Allente"}
];
...
const mainQA = [
  ...
  {q:"Hvorfor søker du på denne jobben?", type:"text", text:"For en \"gammel\" lesehest gir navnet Cappelen Damm gode assosiasjoner med én gang. Jeg leste masse under oppveksten, og er fortsatt glad i det, men akkurat som for målgruppene dere vil nå i deres avdeling, så har andre medier overtatt for en del av tiden jeg før brukte på lesing.<br><br>Jeg er selv mamma til tre ungdommer, og synes det er spennende å se hvordan de lærer på nye måter, og ikke minst hvor trygge de blir på å produsere og presentere eget innhold.<br><br>Selv er jeg en grafisk designer/innholdsprodusent med lang erfaring. Jeg har jobbet med veldig mye forskjellig. Tiden da jeg jobbet i Egmont som nettredaktør for jentebladet Julia, og også som innholdsprodusent for donald.no, minnes jeg som veldig lærerik og meningsfull. Det å skape noe for barn og unge som engasjerer og treffer dem \"der de er\" synes jeg er veldig spennende.<br><br>Jeg har alltid vært opptatt av ny teknologi og systemer, og synes det er gøy med både AI og gamification. Her synes jeg Duolingo er et stjerneeksempel på å engasjere brukeren, og jeg ser at flere bransjer forsøker kopiere deres modell. For min egen del har jeg mengder av apper på mobilen som forenkler min hverdag, og jeg eksperimenterer med å lage egne apper til barna mine for ting i hverdagen der de trenger et \"vennlig dytt\".<br><br><strong>Det var mange ord for å si:</strong> jeg tror jeg passer veldig godt inn hos dere! Jeg ønsker å bruke kreativiteten, nysgjerrigheten og engasjementet mitt til å bidra til at barn og unge får lære på en måte som er tilpasset tiden vi lever i, og samtidig gi lærere de beste verktøyene i sin verktøykasse!", media:[]},
  {q:"Hva mener du er det viktigste du kan bidra med hos oss?", type:"text", text:"Historieformidling, kreativitet og gjennomført visuell kommunikasjon!<br><br>Jeg har som nevnt erfaring med mye innen innholdsproduksjon, noe som gjør at jeg kan se hele bildet, og produsere veldig mye selv. Jeg kan for eksempel både skrive, illustrere, redigere bilder, lage landingssider, klippe video og animere. Og når et nytt læringsverktøy er på plass, kan jeg også bidra til markedsføringen av det!<br><br>Min interesse for AI og apper, gjør at jeg dessuten kan lage raske prototyper som kan testes underveis i prosessen. Se eksempel på en slik app under spørsmålet som er spesifikt om AI.<br><br>Jeg må også nevne at jeg har studert PPU, der jeg fikk prøvd meg litt som lærer både i barneskolen og på videregående. Hadde jeg ikke blitt grafisk designer, hadde jeg nok vært lærer i dag.<br><br>I tillegg bidrar jeg med kreativitet, ideer og humor, og er en utpreget lagspiller som liker godt å jobbe i team.", media:[]},
  {q:"Få høre litt om innhold du har produsert da!", type:"text", text:`Det kan jeg gjøre! Og det blir mye forskjellig ...<br><br>Da jeg jobbet i Egmont var jeg nettredaktør for Juliabladet, med alt det innebærer. Jeg skrev saker om One Direction og Justin Bieber, samt laget konkurranser, quizzer og modererte forum. Jeg planla og illustrerte alt til et eget spill vi hadde på siden som ble veldig populært. Det gikk ut på å kle opp ulike kjendiser i forskjellige antrekk. Jeg samarbeidet også tett med utviklere om å videreutvikle/forbedre siden og få på plass ny funksjonalitet. I en periode jobbet jeg også med donald.no, med quizzer og saker. Jeg har skrevet min ANDel med Andeby-ordspill for å si det sånn.${makeCarousel([
    {type:"image", src:"https://raw.githubusercontent.com/randback-design/meet-randi/main/site/cappelendamm/images/juliano.jpg", label:"Julia.no"},
    {type:"image", src:"https://raw.githubusercontent.com/randback-design/meet-randi/main/site/cappelendamm/images/Juliabladet.jpg", label:"Juliabladet"},
    {type:"image", src:"https://raw.githubusercontent.com/randback-design/meet-randi/main/site/cappelendamm/images/dolls.png", label:"Kle på-spillet"}
  ], "egmontCar")}<br><br>I VG jobbet jeg i et in-house reklamebyrå der vi produserte kreative annonseløsninger for VG/Schibsteds annonsører. Her var engasjement og oppmerksomhet nøkkelord, og vi laget mange annonser der leseren selv måtte interagere. Da Jo Nesbøs "Tørst" kom ut, animerte vi bokcoveret, slik at det faktisk dryppet blod fra bjørnefellen på bildet. En annen gang laget vi en egen landingsside der leserne kunne mikse sammen sin egen milkshake, som oppdrag fra MIX.<br><br>I Allente har jeg jobbet masse med landingssider, A/B-tester av heros og annet innhold, samt optimalisering. Som del av markedsavdelingen lærte jeg mye som hva som funker og ikke funker, og om viktigheten av tydelig og åpen kommunikasjon. Jeg var med å lage nytt malverk for nyhetsbrev, sette opp en effektiv rigg for annonseproduksjon, klippet reels og produserte innhold til SoMe.${makeCarousel([
    {type:"video", vimeoId:"1208078682"}
  ], "torstCar")}`, media:[]},
  {q:"Alle snakker om AI. Hva er dine tanker om det?", type:"text", text:"Jeg skal innrømme at jeg lenge var skeptisk til AI. De første bildene som florerte på nettet, med seks fingre og votter som sko, overbeviste meg ikke akkurat. Og som designer er det jo naturlig å føle seg litt \"truet\" 😅<br><br>Men nå har jo gamet blitt et helt annet, og jeg har innsett at AI kan være en enorm ressurs når det brukes riktig. Jeg bruker det blant annet til idéutvikling, korrektur, strukturering av tekst og til å lage små nettsider og apper som forenkler ting i hverdagen.<br><br>Som nevnt tidligere er jeg veldig fascinert over hva man selv kan utvikle av apper og finurlige små websider som kan forenkle hverdagen, og jeg har brukt mye tid på å lære med Claude. Denne siden er bygget med Claude etter mange instrukser fra meg.<br><br>For å ta et litt personlig eksempel, så har jeg et barn som trenger litt hjelp med å legge på seg. Hun har lite matlyst, men vet godt at hun trenger næringsrik og nok mat, men vår masing gjorde bare spising til et ork. Men for et par måneder siden fikk jeg en idé til en app, der det å velge seg måltider og loggføre dem gir poeng, som igjen gir en synlig belønning i form av en hage som vokser seg frodig og fin. Og når 25 måltider er spist, blir det en liten fysisk belønning å få også. Jeg har lagt ut en kopi av denne appen, som dere gjerne kan få titte på. Den er et godt eksempel på hvordan jeg tenker pedagogisk, jobber og utvikler ideene jeg har.<br><br><a href='https://maren-momser.vercel.app/' target='_blank' style='color:var(--t1);font-weight:700'>maren-momser.vercel.app →</a>", media:[]},
...
function buildHeroContact(){
  ...
  if(SITE_DATA.portfolioUrl) links.push(`<a class="hero-contact-link" href="${SITE_DATA.portfolioUrl}" target="_blank"><div class="hero-contact-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg></div>Portefølje</a>`);
