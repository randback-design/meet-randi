...
const mainQA = [
  ...
  {q:"Hvorfor søker du på denne jobben?", type:"text", text:"Da jeg kom over denne stillingsannonsen, synes jeg at den traff meg bra. Jeg har lang erfaring med kampanjer, kundereiser, innhold til digitale kanaler, og optimalisering basert på data.<br><br>Jeg har også lang erfaring med visuell kommunikasjon og historiefortelling, og tenker at å bruke den hos dere ville kjennes veldig meningsfullt. For min del ville det bety å gå fra medie- og underholdningsbransjen, som har vært veldig gøy å jobbe i, til en jobb der jeg kan bidra enda mer til det som betyr noe i folks hverdag.", media:[]},
  {q:"Hva mener du er det viktigste du kan bidra med hos KF?", type:"text", text:"Jeg har jobbet mye med akkurat det dere beskriver: å planlegge og gjennomføre digitale kampanjer, og bruke analyse og A/B-testing til å forstå hva som treffer og hvorfor. I Allente jobbet jeg tett med et prosjekt for partnerskap, med mange landingssider og mye testing, der vi stadig justerte heros, tekster og innhold basert på hva tallene fortalte oss.<br><br>Jeg er også vant til å tenke helhetlig rundt kundereisen, fra første møte med merkevaren til at noen faktisk konverterer og blir værende. Og så bidrar jeg gjerne med kreativitet og godt innhold, i tillegg til struktur og fremdrift.", media:[]},
  {q:"Hva er du ekstra god på?", type:"text", text:"Jeg er ganske kreativ, og lar meg lett engasjere. Da vil jeg også gjerne sette ideene ut i live temmelig fort og jobber hardt med det. Historiefortelling på tvers av kanaler er også en av mine styrker, samt at jeg kan en del om mye, framfor å være superspesialist på én bestemt ting. Og så liker jeg å bidra der det trengs, og samarbeider godt med andre.", media:[]},
  {q:"Hvordan håndterer du prioriteringer og deadlines?", type:"text", text:"Yes, det er jo ofte noe en må forholde seg til i en travel hverdag. Jeg sparrer alltid med mine kollegaer, slik at vi i fellesskap kommer fram til hva som må prioriteres. Og deadlines har jeg respekt for, og streber alltid etter å levere i tide, selv når det betyr å måtte jobbe ekstra hardt og legge inn noen lange dager/kvelder for å nå dem.<br><br>Men når det er sagt er jeg heller ikke fremmed for å diskutere utsettelse dersom man ser at leveransen ikke blir god nok på grunn av tid. Noen ganger fungerer det å gå med noe som er 80%, mens andre ganger kan det være verdt å bruke to dager ekstra og få et produkt det virkelig skinner av.", media:[]},
