...
const mainQA = [
  ...
  {q:"Hvorfor vil du jobbe hos oss?", type:"text", text:"Som nevnt i introen fremstår det å jobbe med å øke kunnskapen om organdonasjon som noe av det viktigste og mest meningsfulle jeg kan tenke meg å bruke min kompetanse til.<br><br>Jeg er selv registrert som organdonor, og har vært det i mange år. Alle burde etter min mening ha kunnskapen om dette, snakke med sine nærmeste om det, og ha tenkt igjennom hvor man står i dette spørsmålet, slik at det ikke er noe man plutselig må ta stilling til om det verste skulle skje en.<br><br>Jeg er en kreativ person, som brenner for god og tydelig kommunikasjon og god historiefortelling, der medmenneskelighet og varme alltid har vært et viktig element når det gjelder saker som omhandler andre mennesker.<br><br>Ettersom jeg har en bred erfaring fra mange år med innholdsproduksjon, vil jeg kunne bidra med informasjonsvideoer, forklarende animasjoner, engasjerende innhold til sosiale medier, annonseproduksjon og generelt kommunikasjon for alle relevante kanaler.", media:[]},
  {q:"Hvorfor brenner du sterkt for akkurat organdonasjon?", type:"text", text:"Ingen vet hva livet bringer, og om man selv eller noen man er glad i vil ha behov for et nytt organ, eller vil havne i en situasjon der man må ta en slik avgjørelse for en kjær som har mistet livet.<br><br>Jeg er selv mor til en jente på 13 år som er født med en nyresykdom. Med all sannsynlighet vil hun trenge en transplantasjon på et tidspunkt i livet. Det gjør at jeg selvfølgelig engasjerer meg ekstra sterkt, og at jeg har et brennende ønske om å bidra både for henne og for alle andre der ute som trenger et nytt organ.<br><br>Det har gledet meg stort å lese at mange flere har registrert seg som donorer etter alt fokuset det har vært i media på Mette Marit sin lungesykdom.<br><br>Jeg mener selv at jeg balanserer følelsene rundt å ha et barn med nyresykdom fint i hverdagen, og jeg tror at selv om det å jobbe i Stiftelsen Organdonasjon vil kjennes personlig for meg, så ville jeg takle det bra. Jeg mener det vil være en styrke, og også en mulighet for meg til å øke min kunnskap.", media:[]},
