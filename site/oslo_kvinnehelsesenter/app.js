...
const mainQA = [
  ...
  {q:"Hvorfor søker du denne stillingen?", type:"text", text:"Oslo Kvinnehelsesenter jobber med noe jeg synes er genuint viktig – å samle tverrfaglig kompetanse for å løfte kvinnehelse, et felt som fortjener mer oppmerksomhet enn det ofte får. Å få bidra til å synliggjøre den kunnskapen dere har samlet under ett tak, gjennom godt innhold folk faktisk finner og forstår, høres ut som noe jeg både kan og har lyst til å bidra med.<br><br>Jeg liker godt tanken på å jobbe tett med fagfolk – osteopater, fysioterapeuter, ernæringsfysiolog og trenere – for å finne de gode historiene og formidle dem på en måte som er tydelig, tillitvekkende og engasjerende.", media:[]},
  {q:"Få høre litt om innhold du har produsert da!", type:"text", text:"Jeg har produsert innhold for mange ulike målgrupper gjennom de siste 20 årene, men målet har alltid vært det samme: å få folk til å stoppe opp, lese, klikke eller komme tilbake. ✍️<br><br>I Egmont var jeg nettredaktør for Julia og jobbet også med donald.no. Jeg skrev artikler, laget quizzer og konkurranser, modererte forum og utviklet innhold for barn og unge.<br><br>I VG jobbet jeg i et in-house-byrå, der vi utviklet kreative annonsekonsepter med animasjoner, spill og interaktive løsninger.<br><br>I Allente produserte jeg blant annet landingssider, nyhetsbrev, innhold til sosiale medier og video, og jobbet mye med A/B-testing for å finne de løsningene som fungerte best.", media:[]},
  {q:"Hva mener du er det viktigste du kan bidra med hos oss?", type:"text", text:"Jeg tror det viktigste jeg kan bidra med er å ta kunnskapen til et helt team av fagfolk, og gjøre den tilgjengelig og engasjerende for kundene deres – på nettside, sosiale medier og andre flater. Jeg har bred erfaring med innholdsproduksjon, som gjør at jeg kan se helheten og produsere mye selv: skrive, ta bilder, redigere video, og drive en produksjon fra idé til ferdig publisert innhold.<br><br>Jeg er strukturert og vant til å samarbeide tett med fagpersoner for å sikre at innholdet både engasjerer og er faglig riktig.", media:[]},
  {q:"Har du erfaring med foto og video?", type:"text", text:"Ja, video har jeg god erfaring med – jeg klipper selv, og har blant annet ansvar for video- og fotoproduksjon til Trollskogen teater. Jeg er vant til å jobbe i Adobe Premiere og After Effects, og liker godt å fange og formidle ekte øyeblikk, ikke bare det polerte og perfekte.", media:[]},
  ...
  {q:"Alle snakker om AI. Hva er dine tanker om det?", type:"text", text:"Jeg var skeptisk til AI i starten. De første AI-bildene av folk med seks fingre gjorde meg ikke akkurat overbevist. 😅<br><br>I dag bruker jeg AI hver eneste dag. Det er et verktøy som hjelper meg med idéutvikling, research, korrektur og raske prototyper, slik at jeg kan bruke mer tid på kreativitet og historiefortelling.<br><br>Jeg har blant annet laget en liten app til datteren min, der måltider blir til poeng som får en hage til å vokse – et lite eksempel på hvordan jeg liker å kombinere teknologi, kreativitet og brukerinnsikt for å gjøre gode vaner litt mer motiverende. Ta gjerne en titt: <a href='https://mat-motivator.vercel.app/' target='_blank' style='color:var(--t1);font-weight:700'>mat-motivator.vercel.app →</a><br><br>Denne nettsiden er for øvrig også laget ved hjelp av Claude, etter mange runder med prompting og finjustering.", media:[]},
