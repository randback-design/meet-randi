...
const mainQA = [
  ...
  {q:"Hvorfor søker du denne stillingen?", type:"text", text:"Jeg søker på denne stillingen fordi jeg allerede er veldig glad i TV 2. Fra min stilling i Allente har våre veier av og til krysset, og jeg opplever folkene hos dere som veldig dyktige og fine å samarbeide med.<br><br>Dessuten er TV 2 Play den desidert mest brukte streamingtjenesten i min husstand. Farmen, Boksen, Forræder mm. er programmer som samler vår familie på fem foran TV´n. Det vil ikke mangle på engasjement fra meg, om jeg får muligheten til å jobbe med å promotere TV 2 sin fantastiske programrekke.", media:[]},
  {q:"Ser ut som du har sittet på andre siden av bordet før? Fortell!", type:"text", text:"Min erfaring fra Allente burde passe som hånd i hanske til denne stillingen. Jeg har over en periode jobbet på et team i Allente med mål om å sikre nye partnerskap, og min oppgave var nettopp å levere grafikk, retningslinjer, konkurranser, og ikke minst godkjenne oppsettet til slutt.", media:[]},
  {q:"Prosjektledingsskills?", type:"text", text:"Altså, jeg elsker lister, og jeg digger prosjektstyringsverktøy. Men tittelen prosjektleder skal jeg innrømme at jeg aldri har hatt. Eller, kanskje her hjemme. Noen må holde styr på alt tre ungdommer, en hund, 6 høner, og av og til en mann foretar seg til en hver tid. 😄<br><br>Fra spøk til alvor: Jeg har ofte tenkt at jeg kunne passet til en prosjektlederstilling, da det å ha overblikk, systematisere, lage gode rutiner, og ikke minst ta et steg tilbake og forbedre noe som ikke fungerer optimalt, er noe jeg mener jeg er veldig god på.<br><br>Vibe-coding har faktisk vist seg å være nyttig i akkurat dette formålet. Finnes det ikke et godt nok verktøy for det som vil forbedre arbeidsprosessen? Så lag det! Jeg har laget meg mange nettsider og små apper den siste tiden, som har spart meg mye tid, og gitt mye motivasjon.", media:[]},
  {q:"Hvordan jobber du sammen med andre?", type:"text", text:"Jeg trives veldig godt med å samarbeide med andre og jobbe i team, gjerne kryssfunksjonelt.<br><br>Fra min tid i VG ble jeg godt vant til å være med ut i kundemøter der jeg presenterte våre forslag til uttak basert på brief. En av mine styrker er å lage gjennomarbeidede presentasjoner som ser bra ut. Jeg mener det er alfa og omega om man ønsker å selge inn et forslag eller et konsept.<br><br>Ta en titt på omtalene lenger ned på siden her for å lese hva noen av mine tidligere kollegaer sier om hvordan det er å jobbe med meg.", media:[]},
  ...
  {q:"Du er også designer – hvordan vil det være en fordel?", type:"text", text:"Jeg tror min bakgrunn som grafisk designer vil passe veldig godt inn her. Jeg har en bred kompetanse innen visuell kommunikasjon, og et godt øye for hva som fungerer visuelt.", media:[]},
