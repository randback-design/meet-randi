...
const mainQA = [
  ...
  {q:"Programmer?", type:"text", text:"Jeg jobber i de fleste av de store programmene i Adobe CC: Photoshop, InDesign, Illustrator, Premiere og After Effects. Jeg er også godt kjent med Microsoft-verktøyene fra hverdagen i mine tidligere stillinger, med særlig fokus på PowerPoint og Teams, og er glad i å lære nye programmer og verktøy – jeg har blant annet bidratt til å implementere både Monday.com og Bannerflow i Allente (min siste arbeidsplass).", media:[]},
  {q:"Du er også designer – hvordan vil det være en fordel?", type:"text", text:"Jeg tror min bakgrunn som grafisk designer vil passe veldig godt inn her. Jeg har en bred kompetanse innen visuell kommunikasjon, og et godt øye for hva som fungerer visuelt.<br><br>Jeg er også veldig god på å lage gode, strukturerte og gjennomarbeidede presentasjoner. Som person er jeg positiv og blid i møte med andre, og liker gjerne å spille litt på humor. For meg handler en god presentasjon om å være godt forberedt, med et innhold som er både visuelt og innholdsmessig sterkt.<br><br>Som ansvarlig for kundekommunikasjon kan jeg levere både gode og overbevisende innsalg og ferdig tilpasset materiell som vil gjøre det veldig enkelt for TV-distributørene å promotere TV 2 sitt innhold. Dette vet jeg er veldig ettertraktet, av erfaring fra «andre siden av bordet».", media:[]},
  ...
  {q:"Når kan du starte?", type:"text", text:"Jeg er veldig fleksibel når det kommer til oppstart. Som dere jo helt sikkert har fått med dere ble det en betydelig nedbemanning i Allente som følge av at Viaplay tok over fullt eierskap. Derfor er jeg superklar for nye utfordringer og oppgaver, og kan starte på relativt kort varsel.", media:[]},
