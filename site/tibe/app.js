...
function playHeroVideo(){
  ...
  wrap.onclick = null;
  wrap.innerHTML = '<iframe src="https://player.vimeo.com/video/1193523731?h=cf9e85bec3&badge=0&autopause=0&autoplay=1&title=0&byline=0&portrait=0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;inset:0;width:100%;height:100%;border:none;display:block"></iframe>';
}
...
const mainQA = [
  ...
  {q:"Hvorfor søker du denne stillingen?", type:"text", text:"Det som tiltaler meg mest med denne rollen er bredden. Jeg har aldri spesialisert meg på én ting, nettopp fordi jeg trives best med å gjøre litt av alt, og stadig være i utvikling. Jeg er ikke designeren som helst vil sitte i fred med én type oppgave hele dagen – jeg liker å sparre, løse problemer, lære nye ting og veksle mellom idé og produksjon. Det gjør at jeg ofte kan ta ansvar for en full leveranse på egenhånd, med alt fra skissering og svar på brief, til annonseproduksjon, landingssider, illustrasjon og klipping av video, og jeg trives godt i samarbeid med både kreative, kommersielle og tekniske fagmiljøer.<br><br>Jeg er ganske kreativ, og lar meg lett engasjere. Da vil jeg gjerne sette ideene ut i live temmelig fort, og jobber hardt med det. Historiefortelling på tvers av kanaler er en av mine styrker, og jeg liker godt å bidra der det trengs og samarbeide med andre.<br><br>Etter mange år i markedsavdeling, frister det å jobbe i et byrå, å få muligheten til å jobbe med flere ulike kunder og prosjekter igjen, slik jeg gjorde da jeg jobbet i in-house byrå i VG. Å jobbe i Tibe høres ut til å by på mange spennende muligheter i et hyggelig og kreativt miljø – og jeg tror det ville passe meg perfekt.<br><br>Så ja – dette høres veldig ut som en jobb jeg kunne trivdes skikkelig godt i. 😊", media:[]},
  {q:"Har du erfaring med kundedialog?", type:"text", text:"Ja, absolutt. I VG var jeg med ut i kundemøter, leverte svar på briefer, og fulgte opp kontaktpersoner underveis i korrekturrunder.<br><br>I Allente jobbet jeg i cirka et år tett med partnersamarbeid, med mange møter – like ofte med danske og svenske aktører som norske. Så jeg er vant til både norsk og nordisk kundedialog, og trives godt i rollen som en trygg, løsningsorientert sparringspartner.", media:[]},
  {q:"Hva mener du er det viktigste du kan bidra med hos oss?", type:"text", text:"Overblikk, struktur, og det at jeg kan sørge for at all kommunikasjon henger sammen – selv om den tilpasses ulike kunder og kanaler.<br><br>Jeg har erfaring med å jobbe med visuell identitet, og var med å bygge en ny merkevare fra bunnen av i Allente, for så å videreutvikle den i tett samarbeid med kollegaer og byrå. Som nettredaktør for julia.no i Egmont hadde jeg dessuten ansvar for videreutvikling av siden og trafikken dit, så jeg er vant til å eie et nettsted over tid – ikke bare produsere innhold til det.<br><br>Jeg er også vant til å produsere mye selv – fra idé til ferdig leveranse. I tillegg bidrar jeg med kreativitet, ideer og humor, og er en utpreget lagspiller som liker godt å jobbe i team.", media:[]},
  {q:"Hvilke programmer jobber du i?", type:"text", text:"Jeg jobber i de fleste av de store programmene i Adobe CC: Photoshop, InDesign, Illustrator, Premiere og After Effects. Mer om dette ser dere i en egen blokk lengre ned på denne siden. 👇<br><br>Jeg er også glad i å lære nye programmer og verktøy, og har bidratt til å implementere både Monday.com (prosjektstyring) og Bannerflow (annonseproduksjon) på min siste arbeidsplass. Jeg har også nylig tatt et grunnkurs i Canva, da jeg ser at det er mange som benytter seg av dette programmet for tiden, og synes programmet er veldig intuitivt.<br><br>Jeg har satt opp sider i WordPress også, og kan for eksempel fint bygge en side med Elementor. Selve det å kjøpe og implementere et helt nytt oppsett, og gjøre alt det tekniske for å få strukturen opp å gå, har jeg derimot ikke gjort selv – men jeg setter meg raskt inn i nye systemer.", media:[]},
  {q:"Og AI?", type:"text", text:"Jeg skal innrømme at jeg lenge var skeptisk til AI. Alle rare bilder som ble spredd rundt omkring av mennesker som alle så helt like ut i ansiktet, og hadde 6 fingre, og votter som sko.<br><br>Nå er jo gamet blitt et helt annet, og jeg har innsett at man må hive seg på AI-toget. Det har jeg gjort, og nå ser jeg at om man bruker det riktig, kan det være en enorm ressurs.<br><br>Når det er sagt så liker jeg å skrive, og vil fortsatt høres ut som meg, selv om AI kan bidra til god hjelp med korrektur, struktur og kanskje litt nedkortninger. Så selv om denne nettsiden er laget ved hjelp av Claude, er alt som står her i min tone of voice, og designet blitt til gjennom ganske mange timer med prompts.", media:[]},
