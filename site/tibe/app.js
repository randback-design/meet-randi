...
// ── FAQ ──
const mainQA = [
  {q:"Så... hvem er du da?", type:"video", text:"Jeg heter Randi, og har jobbet med design i snart 20 år. Mest som grafisk og digital designer, men egentlig litt alt mulig innen visuell kommunikasjon.<br><br>Dessuten er jeg kreativ, sosial, leken og ganske glad i tempo og mange baller i luften – uten at det går på bekostning av mitt behov for god orden, struktur og overblikk. 🎨 ✅<br><br>Og så er jeg mamma, kjæreste, hundeeier og en ivrig konsert- og teatergjenger. 🎵 Mer om meg i denne animasjonsfilmen jeg har laget:", media:[{type:"video",vimeoId:"1187345684",vimeoHash:"f8b46e121d"}]},
  {q:"Hvorfor søker du denne stillingen?", type:"text", text:"Det som tiltaler meg mest med denne rollen er bredden. Jeg har aldri spesialisert meg på én ting, nettopp fordi jeg trives best med å gjøre litt av alt – og det gjør at jeg kan levere helhetlig, fra illustrasjon og kampanjemateriell til klippet video og digitale flater.<br><br>Jeg er ganske kreativ, og lar meg lett engasjere. Da vil jeg gjerne sette ideene ut i live temmelig fort, og jobber hardt med det. Historiefortelling på tvers av kanaler er en av mine styrker, og jeg liker godt å bidra der det trengs og samarbeide med andre.<br><br>Og så er det noe eget ved byrålivet – å jobbe tett med flere ulike kunder og fagmiljøer samtidig, der design, innhold og teknologi møtes under samme tak.", media:[]},
  ...
  {q:"Kan vi se noen arbeider du har gjort?", type:"text", text:"Ja! Ta en titt her: <a href='https://randback.portfoliobox.net/' target='_blank' style='color:var(--t1);font-weight:700'>randback.portfoliobox.net →</a> Der finner du et utvalg av arbeidene mine, blant annet arbeid for Allente under «Visuell profil», hvor jeg har jobbet med å videreføre og bruke merkevaren i kampanjer og ulike flater.<br><br>Jeg har også lagt inn seks utvalgte case her på siden, lenger ned, for å vise bredden i det jeg kan bidra med. 👇", media:[]},
