...
const mainQA = [
  ...
  {q:"Alle snakker om AI. Hva er dine tanker om det?", type:"text", text:"Jeg var skeptisk til AI i starten. De første AI-bildene av folk med seks fingre gjorde meg ikke akkurat overbevist. 😅 I dag bruker jeg AI hver eneste dag – til idéutvikling, research, korrektur og raske prototyper. Jeg synes det er spesielt interessant hvordan innhold nå også må optimaliseres for AI-drevne plattformer, ikke bare tradisjonelle søkemotorer – det er et felt jeg gjerne fordyper meg mer i, og som jeg ser blir stadig viktigere for nettopp digital synlighet. Denne nettsiden er laget ved hjelp av mange timer med vibe-coding i Claude.", media:[]},
