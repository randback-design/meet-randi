...
function playHeroVideo(){
  ...
  wrap.onclick = null;
  // TODO: bytt til Randis nye Nille-video (ID/hash) når den er klar — bruker foreløpig forrige Nille-video
  wrap.innerHTML = '<iframe src="https://player.vimeo.com/video/1200533412?h=ef8f3c9c51&badge=0&autopause=0&autoplay=1&title=0&byline=0&portrait=0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;inset:0;width:100%;height:100%;border:none;display:block"></iframe>';
}
...
// ── FAQ ──
const mainQA = [
  {q:"Så... hvem er du da?", type:"video", text:"Jeg er Randi. Grafisk designer, innholdsprodusent og litt markedsperson – alt i én og samme person. Kreativ. Humørfylt. Nysgjerrig. Arbeidsom. Positiv.<br><br>Og mamma, samboer og hundeeier. 🐶 Lær mer om meg i denne animasjonsfilmen jeg har laget:", media:[{type:"video",vimeoId:"1187345684",vimeoHash:"f8b46e121d"}]},
  {q:"Hvorfor søker du på denne jobben?", type:"text", text:"Denne gangen er det en litt annen vinkel enn sist jeg søkte hos dere – her er det den digitale og analytiske siden av kommunikasjonen som står i sentrum, og det synes jeg er minst like spennende. Jeg liker godt kombinasjonen av å lage godt innhold og samtidig forstå hva som faktisk fungerer og gir resultater.<br><br>Nille er en merkevare jeg kjenner godt som kunde, og jeg har alltid likt den lekne og gjenkjennelige profilen deres.", media:[]},
  {q:"Hva er din erfaring med SEO og analyse?", type:"text", text:"Jeg har grunnleggende kjennskap til SEO, og har jobbet en del med Google Analytics – blant annet fulgte jeg trafikk og resultater tett som nettredaktør for Julia i Egmont, og senere i Allente med landingssider og A/B-testing for å finne det som fungerte best.<br><br>Jeg vil ikke kalle meg spesialist, men jeg er vant til å bruke innsikt til å justere og forbedre, og er nysgjerrig på å lære enda mer – blant annet hvordan innhold også bør optimaliseres for AI-drevne søk (AEO), noe jeg følger med på.", media:[]},
  {q:"Har du erfaring med CRM-systemer og nyhetsbrev?", type:"text", text:"Jeg har jobbet med CRM i Allente, og var med på å utvikle en ny mal for MessageGears – verktøyet deres for nyhetsbrev og kundekommunikasjon. Jeg har også samarbeidet tett med e-comm-teamet om landingssider, og jobbet mye med A/B-testing på nettsiden for å se hva som faktisk fungerte.<br><br>Jeg vil ikke si jeg er spesialist på CRM, men jeg kjenner godt til hvordan innhold og mal henger sammen med resultater, og lærer gjerne mer om deres oppsett.", media:[]},
  ...
  {q:"Når kan du eventuelt starte i ny jobb?", type:"text", text:"Jeg er fleksibel med oppstart, og kan starte relativt raskt – for eksempel fra 1. oktober.", media:[]},
