...
function playHeroVideo(){
  ...
  wrap.onclick = null;
  wrap.innerHTML = '<iframe src="https://player.vimeo.com/video/1227674350?h=808d5a7d37&badge=0&autopause=0&autoplay=1&title=0&byline=0&portrait=0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;inset:0;width:100%;height:100%;border:none;display:block"></iframe>';
}
...
const mainQA = [
  ...
  {q:"Hvorfor søker du på denne jobben?", type:"text", text:"Denne gangen er det en litt annen vinkel enn sist jeg søkte hos dere – her er det den digitale og analytiske siden av kommunikasjonen som står i sentrum, og det synes jeg kan være like spennende. Jeg liker godt kombinasjonen av å lage godt innhold og samtidig forstå hva som faktisk fungerer og gir resultater.<br><br>Nille er en merkevare jeg kjenner godt som kunde, og jeg har alltid likt den lekne og gjenkjennelige profilen deres.", media:[]},
  ...
  {q:"Har du erfaring med CRM-systemer og nyhetsbrev?", type:"text", text:"Jeg har jobbet med CRM i Allente, og var med på å utvikle en ny mal for MessageGears – verktøyet deres for nyhetsbrev og kundekommunikasjon. Jeg har også samarbeidet tett med e-comm-teamet om landingssider.<br><br>Jeg vil ikke si jeg er spesialist på CRM, men jeg kjenner godt til hvordan innhold og mal henger sammen med resultater, og lærer gjerne mer om deres oppsett.<br><br>Jeg er digitalt anlagt, og synes det er spennende å lære nye systemer og rutiner. Ikke minst er jeg veldig systematisk, og setter orden og overblikk høyt.", media:[]},
