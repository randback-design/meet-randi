...
const mainQA = [
  ...
  {q:"Hva har du mest lyst til å jobbe med?", type:"text", text:"Jeg lar meg inspirere av veldig mye. Så selv om jeg for eksempel er litt hekta på illustrasjon og animasjon for tiden, så er det egentlig ikke programmene jeg jobber i eller en type arbeid som gjør at jeg blir engasjert. Derimot er det det å løse et problem, eller finne en ny, morsom og kreativ vinkling på noe. Så fellesnevneren er – ideer, konsept og nytenkning først, for så å velge kanaler og tilpasse budskapet deretter.<br><br>Men dersom dere lurer på hva jeg kan og har erfaring med, så er dette sånn ca. listen:<br>- Enkel animasjon<br>- Illustrasjon<br>- Bilder og filming (enkelt med mobilen)<br>- Klipping av video<br>- Annonseproduksjon<br>- Innhold til SoMe<br>- Vibe coding<br>- Noe prosjektstyring<br>- Presentasjoner<br>- Kundekontakt<br>- POS-materiell<br>- Materiell til stands<br>- Trykksaker<br>- Web og landingssider", media:[]},
