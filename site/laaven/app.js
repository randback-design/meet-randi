...
function playHeroVideo(){
  ...
  wrap.onclick = null;
  wrap.innerHTML = '<iframe src="https://player.vimeo.com/video/1222998365?h=3cf84e7cfc&badge=0&autopause=0&autoplay=1&title=0&byline=0&portrait=0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;inset:0;width:100%;height:100%;border:none;display:block"></iframe>';
}
...
const mainQA = [
  ...
  {q:"Og hvorfor søker du hos Laaven?", type:"text", text:"Først og fremst - jeg leste innledningen din, Christian, og tenkte «endelig en som bare vil bli kjent med et menneske». Det traff meg med en gang. Jeg har jobbet både i in-house byrå (VG) og markedsavdeling (Allente) i mange år nå, og kjenner meg godt igjen i måten dere jobber på - bredt, tett på kunden, og med et team som utfyller hverandre. Jeg har alltid trivdes best når jeg får ha eierskap til flere prosjekter samtidig, og liker at ingen dag er helt lik.<br><br>Og Hurdal er kanskje ikke rett i nærheten av Nittedal, men jeg er mer enn villig til å kjøre et lite stykke for en jobb som virker så riktig. Og jeg elsker å høre på musikk i bilen, så den biten av dagen blir jo bare en bonus. 🎶", media:[]},
  {q:"Har du erfaring med å følge opp egne kunder og prosjekter fra start til mål?", type:"text", text:"Ja, absolutt. Det siste halvannet året i Allente hadde jeg ansvar for at partnerne vi samarbeidet med fikk det de trengte av grafisk materiell - til web, felt og stands. Det krevde tett oppfølging, gode rutiner og mye kommunikasjon på tvers, og jeg likte den rollen godt. Fra VG er jeg også vant til å levere direkte til annonsører i samarbeid med utviklere.<br><br>Jeg liker å ha oversikt, holde tråder samlet og se til at ting faktisk kommer i mål - ikke bare se bra ut på papiret.", media:[]},
  {q:"Hva har du mest lyst til å jobbe med?", type:"text", text:"Jeg lar meg inspirere av veldig mye. Så selv om jeg for eksempel er litt hekta på illustrasjon og animasjon for tiden, så er det egentlig ikke programmene jeg jobber i eller en type arbeid som gjør at jeg blir engasjert. Derimot er det det å løse et problem, eller finne en ny, morsom og kreativ vinkling på noe. Så fellesnevneren er – ideer, konsept og nytenkning først, for så å velge kanaler og tilpasse budskapet deretter.<br><br><span style='font-weight:600'>Men dersom dere lurer på hva jeg kan og har erfaring med, så er dette sånn ca. listen:</span><ul style='margin:10px 0 0;padding-left:20px;line-height:1.8'><li>Enkel animasjon</li><li>Illustrasjon</li><li>Bilder og filming (enkelt med mobilen)</li><li>Klipping av video</li><li>Annonseproduksjon</li><li>Innhold til SoMe</li><li>Vibe coding</li><li>Noe prosjektstyring</li><li>Presentasjoner</li><li>Kundekontakt</li><li>POS-materiell</li><li>Materiell til stands</li><li>Trykksaker</li><li>Web og landingssider</li></ul>", media:[]},
  ...
  {q:"Hvordan kontakter vi deg?", type:"text", text:"Jeg sier som Gabrielle... «Riiing meg» . 97 72 03 15. Eller send en mail til backmarkrandi@gmail.com 📩<br><br>Og skulle dere ha lyst til å ta en prat, så har jeg både førerkort og bil, og kunne veldig gjerne tenke meg en svipptur til Hurdal.", media:[]}
];
