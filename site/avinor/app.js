...
const mainQA = [
  ...
  {q:"Hvorfor søker du denne stillingen?", type:"text", text:"Avinor er en virksomhet jeg har stor respekt for – dere sørger for noe som binder hele Norge sammen, og det er akkurat den typen samfunnsoppdrag jeg har lyst til å bidra til. Jeg har alltid vært opptatt av hvordan godt innhold kan engasjere mennesker, og har lyst til å bruke 20 års erfaring fra mediebransjen på å fortelle historiene som ligger bak det som gjør at Norge flyr. Jeg har ikke fagbakgrunn innen luftfart selv, men har oppriktig lyst til å lære mer om dette.", media:[]},
  {q:"Hva mener du er det viktigste du kan bidra med hos Avinor?", type:"text", text:"Overblikk, struktur, og massevis av kreativ innspill og ideer! Jeg har god erfaring med å skrive og formidle på tvers av kanaler, og liker å finne den gode historien og samtidig sørge for at den treffer riktig målgruppe på riktig plattform. Jeg kan produsere mye selv – tekst, foto, video – noe som gjør at jeg raskt kan gå fra idé til ferdig innhold, uten alltid å være avhengig av mange ledd.", media:[]},
  {q:"Hvordan er erfaringen din med presse og media?", type:"text", text:"Jeg har begrenset erfaring med den direkte dialogen med media. Til gjengjeld har jeg samarbeidet tett med en rekke partnere og levert kommunikasjonsmateriell til eksterne flater og kampanjer. Fra min tid i VG sitt in-house byrå satt jeg tett på redaksjonen, og fikk et innblikk i tempoet og arbeidsmetodene i en travel mediehverdag. Jeg er komfortabel med å ta kontakt med mennesker, enten det er på telefon eller e-post, og ser på relasjonsbygging som en naturlig del av kommunikasjonsarbeidet.", media:[]},
  {q:"Få høre litt om innhold du har produsert da!", type:"text", text:"Jeg har produsert innhold for mange ulike målgrupper gjennom de siste 20 årene, men målet har alltid vært det samme: å få folk til å stoppe opp, lese, klikke eller komme tilbake. I Egmont var jeg nettredaktør for Julia og jobbet også med donald.no. Jeg skrev artikler, laget quizzer og konkurranser, modererte forum og utviklet innhold for barn og unge. I VG jobbet jeg i et in-house-byrå, der vi utviklet kreative annonsekonsepter med animasjoner, spill og interaktive løsninger. I Allente produserte jeg blant annet landingssider, nyhetsbrev, innhold til sosiale medier og video, og jobbet mye med A/B-testing for å finne de løsningene som fungerte best.", media:[]},
  {q:"Hvordan setter du deg inn i nye, kompliserte fagområder?", type:"text", text:"Jeg blir ekstra motivert når jeg får ta noe komplisert og gjøre det enkelt og engasjerende – enten det er en teknisk prosess, eller noe fra et fagmiljø jeg selv ikke kjenner fra før. Jeg liker å gjøre komplekse ting lettere å forstå ved hjelp av et enkelt og tydelig språk, samt bilder, video, animasjon og illustrasjon for å gjøre det lettere å få med seg viktige budskap. Jeg er nysgjerrig av natur, stiller gjerne spørsmål til jeg forstår noe skikkelig, og trives godt med å samarbeide tett med fagfolk for å sikre at det jeg lager både engasjerer og er riktig.", media:[]},
  ...
  {q:"Og AI, som alle snakker om for tiden?", type:"text", text:"Jeg skal innrømme at jeg lenge var skeptisk til AI. De første bildene som florerte på nettet, med seks fingre og votter som sko, overbeviste meg ikke akkurat. 😅 Men nå har jo gamet blitt et helt annet, og jeg har innsett at AI kan være en enorm ressurs når det brukes riktig.<br><br>Jeg bruker det blant annet til idéutvikling, korrektur og strukturering av tekst. Men jeg har også kastet meg ut i vibe coding, altså det å bygge nettsider og små apper ved å beskrive hva jeg vil ha, og la AI-en gjøre jobben med koden. Denne søknadssiden er faktisk et godt eksempel – jeg har brukt Claude og mange timer med prompting for å få både design og funksjonalitet slik jeg ønsket det, uten å skrive koden selv.<br><br>Jeg liker fortsatt best å skrive selv når det gjelder ord og tekst, men å oppdage at jeg kan gå fra idé til ferdig nettside eller app, det har åpnet opp for en helt ny måte å jobbe kreativt på.", media:[]},
  ...
  {q:"Hvordan kontakter vi deg?", type:"text", text:"Jeg sier som Gabrielle... «Riiing meg» . 97 72 03 15. Eller send en mail til backmarkrandi@gmail.com 📩", media:[]}
];
