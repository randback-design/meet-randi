...
// ── FAQ ──
const mainQA = [
  {q:"Så... hvem er du da?", type:"video", text:"Jeg heter Randi, og har jobbet med kommunikasjon, innhold og design i snart 20 år. Mest som grafisk og digital designer, men egentlig litt alt mulig innen visuell kommunikasjon, innholdsproduksjon og markedsføring.<br><br>Jeg er kreativ, sosial, leken og ganske glad i tempo og mange baller i luften, uten at det går på bekostning av mitt behov for god orden, struktur og overblikk. 🎨 ✅<br><br>Og så er jeg mamma til tre fine ungdommer, samboer, hundeeier og en ivrig konsert- og teatergjenger. 🎵 Mer om meg i denne animasjonsfilmen jeg har laget:", media:[{type:"video",vimeoId:"1187345684",vimeoHash:"f8b46e121d"}]},
  {q:"Hvorfor søker du denne stillingen?", type:"text", text:"Avinor er en virksomhet jeg har stor respekt for. Dere sørger for noe som binder hele Norge sammen, og det er akkurat den typen samfunnsoppdrag jeg har lyst til å bidra til.<br><br>Jeg har alltid vært opptatt av hvordan godt innhold kan engasjere mennesker, og har lyst til å bruke 20 års erfaring fra mediebransjen og markedsarbeid på å fortelle historiene som ligger bak det som gjør at Norge flyr.<br><br>Og her virker det som det finnes veldig mange av dem! Historier om mennesker, teknologi, utvikling, sikkerhet og alt det som skjer bak kulissene og som de fleste av oss passasjerer egentlig ikke tenker over.<br><br>Jeg har ikke fagbakgrunn innen luftfart selv, men har oppriktig lyst til å lære mer om dette.", media:[]},
  {q:"Hva mener du er det viktigste du kan bidra med hos Avinor?", type:"text", text:"Overblikk, struktur og massevis av kreative innspill og ideer!<br><br>Jeg har god erfaring med å skrive og formidle på tvers av kanaler, og liker å finne den gode historien og samtidig sørge for at den treffer riktig målgruppe på riktig plattform.<br><br>En av styrkene mine er også at jeg kan produsere mye selv. Tekst, foto, video, grafikk og animasjon. Det gjør at jeg raskt kan gå fra idé til ferdig innhold, uten alltid å være avhengig av mange ledd.<br><br>Jeg tror kombinasjonen av kommunikasjonsforståelse og en ganske stor kreativ verktøykasse kan være nyttig hos Avinor.", media:[]},
  {q:"Hvordan er erfaringen din med presse og media?", type:"text", text:"Jeg har begrenset erfaring med selve pressehåndteringen, så akkurat der har jeg absolutt noe å lære.<br><br>Men jeg har til gjengjeld jobbet store deler av karrieren min i mediebransjen, blant annet i Egmont og VG. Det har gitt meg god forståelse for hvordan innhold blir vinklet, hva som gjør en historie interessant og hvor viktig det er å kommunisere tydelig og presist.<br><br>Jeg har også samarbeidet tett med en rekke partnere og fagmiljøer og levert kommunikasjonsmateriell til eksterne flater og kampanjer. Jeg er komfortabel med å ta kontakt med mennesker, enten det er på telefon, e-post eller ansikt til ansikt, og ser på relasjonsbygging som en naturlig del av kommunikasjonsarbeidet.", media:[]},
  {q:"Få høre litt om innhold du har produsert da!", type:"text", text:"Jeg har produsert innhold for mange ulike målgrupper gjennom de siste 20 årene, men målet har alltid vært omtrent det samme: å få folk til å stoppe opp, lese, klikke eller komme tilbake.<br><br>I Egmont var jeg nettredaktør for Julia og jobbet også med donald.no. Jeg skrev artikler, laget quizzer og konkurranser, modererte forum og utviklet innhold for barn og unge.<br><br>I VG jobbet jeg i et in-house-byrå, der vi utviklet kreative annonsekonsepter med animasjoner, spill og interaktive løsninger.<br><br>I Allente jobbet jeg i markedsavdelingen og produserte blant annet landingssider, nyhetsbrev, innhold til sosiale medier, kampanjemateriell og video. Jeg jobbet også mye med A/B-testing for å finne løsningene som fungerte best.<br><br>Jeg liker aller best å kunne følge innholdet hele veien fra «Dette burde vi lage noe på!» til ferdig publisert løsning.", media:[]},
  {q:"Hvordan setter du deg inn i nye, kompliserte fagområder?", type:"text", text:"Jeg blir ekstra motivert når jeg får ta noe komplisert og gjøre det enkelt og engasjerende, enten det er en teknisk prosess eller noe fra et fagmiljø jeg selv ikke kjenner fra før.<br><br>Jeg liker å gjøre komplekse ting lettere å forstå ved hjelp av et enkelt og tydelig språk, og gjerne bilder, video, animasjon eller illustrasjon når det kan gjøre budskapet enda lettere å få med seg.<br><br>Jeg er nysgjerrig av natur og stiller gjerne spørsmål til jeg forstår noe skikkelig. Og jeg trives godt med å samarbeide tett med fagfolk for å sikre at det jeg lager både engasjerer og faktisk er riktig.<br><br>Jeg trenger altså ikke kunne alt fra før. Men jeg må forstå det før jeg skal forklare det videre.", media:[]},
  {q:"Programmer?", type:"text", text:"Jeg jobber i de fleste av de store programmene i Adobe CC: Photoshop, InDesign, Illustrator, Premiere og After Effects.<br><br>Jeg er også glad i å lære nye programmer og verktøy, og har blant annet bidratt til å implementere både Monday.com og Bannerflow i Allente.<br><br>Og hvis jeg møter et program jeg ikke kan? Da lærer jeg det. Jeg synes faktisk den delen er ganske gøy.", media:[]},
  {q:"Og AI, som alle snakker om for tiden?", type:"text", text:"Jeg skal innrømme at jeg lenge var skeptisk til AI. De første bildene som florerte på nettet, med seks fingre og votter som sko, overbeviste meg ikke akkurat. 😅<br><br>Men nå har jo gamet blitt et helt annet, og jeg har innsett at AI kan være en enorm ressurs når det brukes riktig.<br><br>Jeg bruker det blant annet til idéutvikling, korrektur og strukturering av tekst. Men jeg har også kastet meg ut i vibe coding, altså det å bygge nettsider og små apper ved å beskrive hva jeg vil ha, og la AI gjøre jobben med koden. Denne søknadssiden er faktisk et godt eksempel. Jeg har brukt Claude og mange timer med prompting for å få både design og funksjonalitet slik jeg ønsket det, uten å skrive koden selv.<br><br>Jeg liker fortsatt best å skrive selv når det gjelder ord og tekst, men å oppdage at jeg kan gå fra idé til ferdig nettside eller app har åpnet opp for en helt ny måte å jobbe kreativt på.", media:[]},
  {q:"Hva med det sosiale?", type:"text", text:"Jeg bidrar med humor, godt humør, tørre ordspill, musikktips og engasjement.<br><br>I min forrige jobb satt jeg mange år i sosialkomiteen, og bidro til at miljøet på jobb var godt, og at det ble både sommerfest og julebord. 🎉<br><br>Jeg liker å jobbe sammen med flinke folk, sparre, dele ideer og lære av andre. Og så synes jeg rett og slett det er viktig å ha det hyggelig på jobb.", media:[]},
  {q:"Når kan du eventuelt starte i ny jobb?", type:"text", text:"Jeg er ganske fleksibel når det kommer til oppstart. For noen måneder siden ble jeg rammet av en nedbemanning i min forrige jobb, da et eierskifte i Allente førte til at ca. halvparten måtte gå.<br><br>Nå er jeg superklar for nye utfordringer og oppgaver, og kan starte på relativt kort varsel.", media:[]},
  {q:"Hvordan kontakter vi deg?", type:"text", text:"Jeg sier som Gabrielle... «Riiing meg». 📞<br><br>97 72 03 15<br><br>Eller send en mail til backmarkrandi@gmail.com 📩", media:[]}
];
